            ...
            <div class=" shadow-1lg p-6 ">
                <div class="flex">
                    ...
                    <div class="lg:flex-1 lg:p-8">
                        <h2 class="text-2xl font-bold"> <span class="underline decoration-2 underline-offset-8 decoration-orange-400 ">Ap</span>a itu SCC?</h2>
                ...
                <section>
                    ...
                    <div class="mt-8 ">
                        <h2 class="text-2xl font-bold"> <span class="underline decoration-2 underline-offset-8 decoration-orange-400">Ru</span>angan yang tersedia</h2>
                    </div>
                                ...
                                <div class="swiper-slide">
                                    <x-card>
                                        <x-card.image-container>
                                            <x-card.image alt="ruangan" src="{{\Illuminate\Support\Facades\Storage::url($room->images)}}"/>
                                        </x-card.image-container>
                                        <x-card.container>
